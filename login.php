				...
				<div class="leftside">
					<div class="contact-form">
						...
						<div class="form-group group-coustume">
							...
							<button type="button" id="login" class="btn btn-default btn-submit" style="margin-left:64.5%">Submit</button>
							<p id="msg"></p>
						</div>
					</div>
				</div>
	...
	$(document).ready(function(){
		$("#login").click(function(){
			...
			if(email!="" && email!=" " && pass!="" && pass!=" "){
				...
				xhttp.send("email="+email+"&pass="+pass+"&opc=2");
			}
			else{
				$("#msg").css("color","red");
